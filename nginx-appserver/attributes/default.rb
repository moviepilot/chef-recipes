...
default[:nginx_appserver][:passenger_root] = "#{default[:nginx_appserver][:ruby_path]}/lib/ruby/gems/#{`ls -1 #{default[:nginx_appserver][:ruby_path]}/lib/ruby/gems/ | sort -n | head -n 1`.strip}/gems/passenger-#{default[:nginx_appserver][:version]}"
